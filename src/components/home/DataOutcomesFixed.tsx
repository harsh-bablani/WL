...
const outcomes = [
  ...
  },
  {
    ...
    metric: '78%',
    detail: 'Of patients reported improved health outcomes after receiving accurate diagnostic results from their healthcare provider'
  },
  {
    icon: Target,
    ...
    metric: '85%',
    detail: 'Of high-risk patients decreased their risk level after receiving accurate diagnostic results and preventive care'
  },
  {
    icon: Award,
    title: 'Lower Healthcare Costs',
    description: 'Everyone wins when diagnostic testing is accurate and efficient',
    metric: '95%',
    detail: 'Of administrators report reduced workload through our streamlined platform'
  }
];

export default function DataOutcomesFixed() {
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-teal-50/30 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-20 w-64 h-64 bg-teal-100/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-cyan-100/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-8 max-w-5xl mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
            Turn <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-cyan-500 to-teal-600">Diagnostic Data into Action</span>
          </h2>
          <p className="text-xl text-gray-600 leading-relaxed mb-12 max-w-4xl mx-auto animate-slide-up" style={{ animationDelay: '0.4s' }}>
            With advanced diagnostic technology at core, Wellness Healthcare helps patients and doctors 
            transform test results into actionable health insights. From accurate diagnostics to preventive care, 
            our expert pathologists provide the tools and guidance you need to make informed decisions, 
        ...
        <div className="bg-gradient-to-br from-white via-teal-50 to-cyan-50 rounded-3xl p-12 shadow-2xl border border-teal-100/50 backdrop-blur-sm relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-teal-200/20 rounded-full blur-2xl animate-pulse" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-8 text-lg">
                Our comprehensive platform provides foundation for data-driven wellness 
            ...
            <div className="relative">
              ...
              {/* Floating decoration */}
              <div className="absolute -bottom-4 -right-4 w-8 h-8 bg-teal-500 rounded-full opacity-20 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
